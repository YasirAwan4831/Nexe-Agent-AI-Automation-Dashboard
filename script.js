...
const PROJECTS = [
  {
    ...
    desc: 'An intelligent conversational chatbot powered by AI language models. Supports multi-turn dialogue, context memory, and a clean web-based chat interface for seamless user interaction.',
    techs: ['Python', 'OpenAI API', 'Flask', 'HTML/CSS'],
    repo:     'YOUR_GITHUB_REPO_1',
    live:     'YOUR_LIVE_LINK_1',
    linkedin: 'YOUR_LINKEDIN_POST_1',
    article:  'YOUR_ARTICLE_1',
  },
  {
    id: 2, featured: false,
    icon: ICON.mail,
    ...
    desc: 'A professional Python automation system that sends, schedules, and manages emails via Gmail API using OAuth 2.0. Features HTML templates, email logging, and a clean terminal interface.',
    techs: ['Python', 'Gmail API', 'OAuth 2.0', 'Schedule'],
    repo:     'YOUR_GITHUB_REPO_2',
    live:     'YOUR_LIVE_LINK_2',
    linkedin: 'YOUR_LINKEDIN_POST_2',
    article:  'YOUR_ARTICLE_2',
  },
  {
    id: 3, featured: false,
    icon: ICON.doc,
    ...
    techs: ['Python', 'NLP', 'OpenAI', 'PyPDF2'],
    repo:     'YOUR_GITHUB_REPO_3',
    live:     'YOUR_LIVE_LINK_3',
    linkedin: 'YOUR_LINKEDIN_POST_3',
    article:  'YOUR_ARTICLE_3',
  },
  {
    id: 4, featured: false,
    icon: ICON.chat,
    ...
    desc: 'A powerful WhatsApp automation tool for scheduling messages, bulk sending, and automated replies. Built with Twilio/pywhatkit for seamless communication workflows.',
    techs: ['Python', 'Twilio', 'pywhatkit', 'Schedule'],
    repo:     'YOUR_GITHUB_REPO_4',
    live:     'YOUR_LIVE_LINK_4',
    linkedin: 'YOUR_LINKEDIN_POST_4',
    article:  'YOUR_ARTICLE_4',
  },
  {
    id: 5, featured: true,
    icon: ICON.agent,
    ...
    desc: 'An autonomous AI agent capable of using multiple tools — web search, file handling, code execution, and API calls — to complete complex tasks step-by-step without human intervention.',
    techs: ['LangChain', 'Python', 'OpenAI', 'Tools API'],
    repo:     'YOUR_GITHUB_REPO_5',
    live:     'YOUR_LIVE_LINK_5',
    linkedin: 'YOUR_LINKEDIN_POST_5',
    article:  'YOUR_ARTICLE_5',
  },
  {
    id: 6, featured: true,
    icon: ICON.rag,
    ...
    repo:     'YOUR_GITHUB_REPO_6',
    live:     'YOUR_LIVE_LINK_6',
